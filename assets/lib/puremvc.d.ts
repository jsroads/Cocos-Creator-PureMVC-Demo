...
declare class View implements IView {
     ...
     * @protected
     */
    mediatorMap: Record<string, IMediator>;
    /**
     * Mapping of <code>Notification</code> names to <code>Observers</code> lists.
     *
     * @protected
     */
    observerMap: Record<string, IObserver[]>;
    /**
...
export { Controller, Facade, ICommand, IController, IFacade, IMediator, IModel, INotification, INotifier, IObserver, IProxy, IView, MacroCommand, Mediator, Model, Notification, Notifier, Observer, Proxy, SimpleCommand, View };
